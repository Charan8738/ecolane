...
const RidersListTable = ({ data, columns, pagination, actions, className, selectableRows, expandableRows }) => {
...
const dataTableColumns = [
  ...
  {
    name: "In Time",
    selector: (row) => <Moment format="MMMM Do YYYY, h:mm a">{row.Intime}</Moment>,
    sortable: true,
    hide: "sm",
  },
  {
    name: "Out Time",
    selector: (row) => <Moment format="MMMM Do YYYY, h:mm a">{row.Outtime}</Moment>,
    sortable: true,
    hide: "sm",
  },
