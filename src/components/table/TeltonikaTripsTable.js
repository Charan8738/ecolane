...
const TeltonikaTripsTable = ({ data, columns, pagination, actions, className, selectableRows, expandableRows }) => {
...
export default TeltonikaTripsTable;
...
const dataTableColumns = [
  {
    ...
    selector: (row) => (
      <span>
        {row.startLatitude},<br></br> {row.startLongitude}
      </span>
    ),
    sortable: true,
  },
  {
    ...
    selector: (row) => (
      <span>
        {row.EndLatitude},<br></br> {row.EndLongitude}
      </span>
    ),
    sortable: true,
    hide: 370,
  ...
  },
  {
    name: "Distance(miles)",
    selector: (row) =>
      distance(row.startLatitude, row.startLongitude, row.EndLatitude, row.EndLongitude, "miles").toFixed(2),
    sortable: true,
    hide: "md",
  },
  // {
